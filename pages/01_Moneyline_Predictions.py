...
week10_games_fd = [
    ...
    get_team_features(df, 2025, "CHI", spread=-4.5, total=46.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "NYG", spread=+4.5, total=46.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "RAV", spread=-4.5, total=48.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "MIN", spread=+4.5, total=48.5, home=0, stat_cols_for_avg=stat_cols),
    ...
    get_team_features(df, 2025, "CAR", spread=-5.5, total=38.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "NOR", spread=+5.5, total=38.5, home=0, stat_cols_for_avg=stat_cols),
    ...
    get_team_features(df, 2025, "SEA", spread=-7.0, total=44.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CRD", spread=+7.0, total=44.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "SFO", spread=+5.5, total=49.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "RAM", spread=-5.5, total=49.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "WAS", spread=+7.5, total=48.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "DET", spread=-7.5, total=48.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "SDG", spread=-2.5, total=44.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "PIT", spread=+2.5, total=44.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "GNB", spread=-1.5, total=44.5, home=1, stat_cols_for_avg=stat_cols),
...
week10_games_dk = [
    ...
    get_team_features(df, 2025, "NYJ", spread=+1.5, total=37.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CLE", spread=-1.5, total=37.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CAR", spread=-5.5, total=38.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "NOR", spread=+5.5, total=38.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "MIA", spread=+9.5, total=50.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "BUF", spread=-9.5, total=50.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "TAM", spread=-2.5, total=48.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "NWE", spread=+2.5, total=48.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "SEA", spread=-7.0, total=45.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CRD", spread=+7.0, total=45.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "SFO", spread=+6.0, total=49.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "RAM", spread=-6.0, total=49.5, home=0, stat_cols_for_avg=stat_cols),
    ...
    get_team_features(df, 2025, "GNB", spread=-1.5, total=45.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "PHI", spread=+1.5, total=45.5, home=0, stat_cols_for_avg=stat_cols),
]
