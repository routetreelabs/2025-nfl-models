...
week15_games_fd = [
    ...
    get_team_features(df, 2025, "JAX", spread=-13.5, total=40.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "NYJ", spread=+13.5, total=40.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "HTX", spread=-10.5, total=42.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CRD", spread=+10.5, total=42.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "NWE", spread=+2.5, total=49.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "BUF", spread=-2.5, total=49.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "KAN", spread=-5.5, total=41.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "SDG", spread=+5.5, total=41.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "PHI", spread=-11.5, total=37.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "RAI", spread=+11.5, total=37.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CIN", spread=+3.0, total=51.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "RAV", spread=-3.0, total=51.5, home=0, stat_cols_for_avg=stat_cols),
    ...
    get_team_features(df, 2025, "CHI", spread=-7.5, total=38.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CLE", spread=+7.5, total=38.5, home=0, stat_cols_for_avg=stat_cols),
    ...
    get_team_features(df, 2025, "NOR", spread=+2.5, total=41.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CAR", spread=-2.5, total=41.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "DEN", spread=+1.5, total=42.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "GNB", spread=-1.5, total=42.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "SEA", spread=-13.5, total=41.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CLT", spread=+13.5, total=41.5, home=0, stat_cols_for_avg=stat_cols),
    ...
    get_team_features(df, 2025, "PIT", spread=-3.0, total=41.5, home=1, stat_cols_for_avg=stat_cols),
...
week15_games_dk = [
    ...
    get_team_features(df, 2025, "JAX", spread=-14.0, total=40.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "NYJ", spread=+14.0, total=40.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "HTX", spread=-10.5, total=42.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CRD", spread=+10.5, total=42.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "NWE", spread=+2.5, total=49.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "BUF", spread=-2.5, total=49.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "KAN", spread=-5.5, total=41.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "SDG", spread=+5.5, total=41.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "PHI", spread=-12.5, total=37.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "RAI", spread=+12.5, total=37.5, home=0, stat_cols_for_avg=stat_cols),
