...
week11_games_fd = [
    ...
    get_team_features(df, 2025, "MIA", spread=-2.5, total=46.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "WAS", spread=+2.5, total=46.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "MIN", spread=-2.5, total=47.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CHI", spread=+2.5, total=47.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "NYG", spread=+7.5, total=42.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "GNB", spread=-7.5, total=42.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "ATL", spread=-3.5, total=41.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CAR", spread=+3.5, total=41.5, home=0, stat_cols_for_avg=stat_cols),
    ...
    get_team_features(df, 2025, "PIT", spread=-5.5, total=48.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CIN", spread=+5.5, total=48.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "BUF", spread=-6.0, total=46.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "TAM", spread=+6.0, total=46.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "OTI", spread=+5.5, total=37.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "HTX", spread=-5.5, total=37.5, home=0, stat_cols_for_avg=stat_cols),
    ...
    get_team_features(df, 2025, "CRD", spread=+3.5, total=48.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "SFO", spread=-3.5, total=48.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "DEN", spread=+4.5, total=44.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "KAN", spread=-4.5, total=44.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CLE", spread=+7.5, total=38.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "RAV", spread=-7.5, total=38.5, home=0, stat_cols_for_avg=stat_cols),
...
week11_games_dk = [
    ...
    get_team_features(df, 2025, "NYG", spread=+7.0, total=42.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "GNB", spread=-7.0, total=42.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "ATL", spread=-3.5, total=41.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CAR", spread=+3.5, total=41.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "JAX", spread=+3.0, total=43.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "SDG", spread=-3.0, total=43.5, home=0, stat_cols_for_avg=stat_cols),
