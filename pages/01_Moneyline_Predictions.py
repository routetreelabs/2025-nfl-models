...
week12_games_fd = [
    ...
    get_team_features(df, 2025, "CIN", spread=+6.5, total=50.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "NWE", spread=-6.5, total=50.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CHI", spread=-2.5, total=44.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "PIT", spread=+2.5, total=44.5, home=0, stat_cols_for_avg=stat_cols),
    ...
    get_team_features(df, 2025, "OTI", spread=+13.5, total=40.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "SEA", spread=-13.5, total=40.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "DET", spread=-10.5, total=49.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "NYG", spread=+10.5, total=49.5, home=0, stat_cols_for_avg=stat_cols),
    ...
    get_team_features(df, 2025, "NOR", spread=-1.5, total=39.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "ATL", spread=+1.5, total=39.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "DAL", spread=+3.5, total=47.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "PHI", spread=-3.5, total=47.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "RAM", spread=-6.5, total=49.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "TAM", spread=+6.5, total=49.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "SFO", spread=-7.0, total=48.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CAR", spread=+7.0, total=48.5, home=0, stat_cols_for_avg=stat_cols),
]
...
week12_games_dk = [
    ...
    get_team_features(df, 2025, "CIN", spread=+7.0, total=50.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "NWE", spread=-7.0, total=50.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CHI", spread=-2.5, total=45.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "PIT", spread=+2.5, total=45.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "RAV", spread=-13.5, total=44.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "NYJ", spread=+13.5, total=44.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "OTI", spread=+13.5, total=40.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "SEA", spread=-13.5, total=40.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "DET", spread=-10.5, total=50.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "NYG", spread=+10.5, total=50.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "GNB", spread=-6.5, total=41.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "MIN", spread=+6.5, total=41.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "RAI", spread=-3.5, total=36.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CLE", spread=+3.5, total=36.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CRD", spread=+3.0, total=47.5, home=1, stat_cols_for_avg=stat_cols),
