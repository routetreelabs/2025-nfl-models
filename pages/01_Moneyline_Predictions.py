...
week18_games_fd = [
    ...
    get_team_features(df, 2025, "RAM", spread=-14.5, total=47.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CRD", spread=+14.5, total=47.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "BUF", spread=-11.5, total=38.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "NYJ", spread=+11.5, total=38.5, home=0, stat_cols_for_avg=stat_cols),
...
week18_games_dk = [
    ...
    get_team_features(df, 2025, "CHI", spread=-4.5, total=51.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "DET", spread=+4.5, total=51.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "DEN", spread=-14.0, total=37.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "SDG", spread=+14.0, total=37.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "NWE", spread=-13.5, total=45.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "MIA", spread=+13.5, total=45.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "PHI", spread=-3.5, total=38.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "WAS", spread=+3.5, total=38.5, home=0, stat_cols_for_avg=stat_cols),
