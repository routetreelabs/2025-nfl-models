...
week16_games_fd = [
    get_team_features(df, 2025, "SEA", spread=+1.5, total=44.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "RAM", spread=-1.5, total=44.5, home=0, stat_cols_for_avg=stat_cols),
    ...
    get_team_features(df, 2025, "CLE", spread=+10.5, total=42.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "BUF", spread=-10.5, total=42.5, home=0, stat_cols_for_avg=stat_cols),
    ...
    get_team_features(df, 2025, "MIA", spread=+2.5, total=50.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CIN", spread=-2.5, total=50.5, home=0, stat_cols_for_avg=stat_cols),
    ...
    get_team_features(df, 2025, "DEN", spread=-3.0, total=45.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "JAX", spread=+3.0, total=45.5, home=0, stat_cols_for_avg=stat_cols),
...
week16_games_dk = [
    ...
    get_team_features(df, 2025, "HTX", spread=-14.5, total=38.5, home=1, stat_cols_for_avg=stat_cols),
