...
csv_path = os.path.join(DATA_DIR, "nfl_gamelogs_vegas_2015-2025_ML_week10_copy.csv")
...
week11_teams = [
    ...
    {"Home": "Dolphins", "Away": "Commanders"},
    {"Home": "Vikings", "Away": "Bears"},
    {"Home": "Giants", "Away": "Packers"},
    {"Home": "Falcons", "Away": "Panthers"},
    {"Home": "Jaguars", "Away": "Chargers"},
    {"Home": "Steelers", "Away": "Bengals"},
    {"Home": "Bills", "Away": "Buccaneers"},
    {"Home": "Titans", "Away": "Texans"},
    {"Home": "Rams", "Away": "Seahawks"},
    {"Home": "Cardinals", "Away": "49ers"},
    {"Home": "Broncos", "Away": "Chiefs"},
    {"Home": "Browns", "Away": "Ravens"},
    {"Home": "Eagles", "Away": "Lions"},
    {"Home": "Raiders", "Away": "Cowboys"},
]

# Week x - FANDUEL

st.markdown("---")
st.subheader("Week 11 Predictions - FanDuel Lines")

week11_games_fd = [
    get_team_features(df, 2025, "NWE", spread=-12.5, total=43.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "NYJ", spread=+12.5, total=43.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "MIA", spread=-2.5, total=47.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "WAS", spread=+2.5, total=47.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "MIN", spread=-3.0, total=47.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CHI", spread=+3.0, total=47.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "NYG", spread=+7.0, total=43.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "GNB", spread=-7.0, total=43.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "ATL", spread=-3.5, total=42.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CAR", spread=+3.5, total=42.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "JAX", spread=+3.0, total=43.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "SDG", spread=-3.0, total=43.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "PIT", spread=-5.5, total=49.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CIN", spread=+5.5, total=49.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "BUF", spread=-5.5, total=47.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "TAM", spread=+5.5, total=47.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "OTI", spread=+6.5, total=37.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "HTX", spread=-6.5, total=37.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "RAM", spread=-3.0, total=48.5, home=1, stat_cols_for_avg=stat_cols),
    ...
    get_team_features(df, 2025, "SFO", spread=-3.0, total=47.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "DEN", spread=+3.5, total=44.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "KAN", spread=-3.5, total=44.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CLE", spread=+7.5, total=39.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "RAV", spread=-7.5, total=39.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "PHI", spread=-2.5, total=46.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "DET", spread=+2.5, total=46.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "RAI", spread=+3.5, total=50.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "DAL", spread=-3.5, total=50.5, home=0, stat_cols_for_avg=stat_cols),
]
...
if st.button("Run Week 11 Predictions - FanDuel"):
    ...
    for i in range(0, len(probs), 2):  # pair home/away
        game_index = i // 2
        home = week11_teams[game_index]["Home"]
        away = week11_teams[game_index]["Away"]
...
# Week x - DRAFTKINGS
st.markdown("---")
st.subheader("Week 11 Predictions - DraftKings Lines")
...
week11_games_dk = [
    ...
    get_team_features(df, 2025, "MIA", spread=-2.5, total=47.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "WAS", spread=+2.5, total=47.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "MIN", spread=-3.0, total=48.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CHI", spread=+3.0, total=48.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "NYG", spread=+7.0, total=43.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "GNB", spread=-7.0, total=43.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "ATL", spread=-3.5, total=42.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CAR", spread=+3.5, total=42.5, home=0, stat_cols_for_avg=stat_cols),
    ...
    get_team_features(df, 2025, "PIT", spread=-5.5, total=49.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CIN", spread=+5.5, total=49.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "BUF", spread=-5.5, total=48.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "TAM", spread=+5.5, total=48.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "OTI", spread=+6.5, total=37.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "HTX", spread=-6.5, total=37.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "RAM", spread=-3.0, total=48.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "SEA", spread=+3.0, total=48.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CRD", spread=+3.0, total=48.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "SFO", spread=-3.0, total=48.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "DEN", spread=+3.5, total=43.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "KAN", spread=-3.5, total=43.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CLE", spread=+7.5, total=39.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "RAV", spread=-7.5, total=39.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "PHI", spread=-2.5, total=46.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "DET", spread=+2.5, total=46.5, home=0, stat_cols_for_avg=stat_cols),
