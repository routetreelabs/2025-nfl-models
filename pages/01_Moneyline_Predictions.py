...
week13_games_fd = [
    ...
    get_team_features(df, 2025, "NYJ", spread=+3.0, total=37.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "ATL", spread=-3.0, total=37.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CLT", spread=-3.5, total=44.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "HTX", spread=+3.5, total=44.5, home=0, stat_cols_for_avg=stat_cols),
...
week13_games_dk = [
    ...
    get_team_features(df, 2025, "TAM", spread=-3.5, total=44.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CRD", spread=+3.5, total=44.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "OTI", spread=+6.0, total=41.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "JAX", spread=-6.0, total=41.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "MIA", spread=-5.5, total=42.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "NOR", spread=+5.5, total=42.5, home=0, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "CLE", spread=+5.5, total=35.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "SFO", spread=-5.5, total=35.5, home=0, stat_cols_for_avg=stat_cols),
