...
week13_games_fd = [
    ...
    get_team_features(df, 2025, "CAR", spread=+9.5, total=44.5, home=1, stat_cols_for_avg=stat_cols),
    get_team_features(df, 2025, "RAM", spread=-9.5, total=44.5, home=0, stat_cols_for_avg=stat_cols),
